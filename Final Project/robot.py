...
class Robot:
    ...
    def handle_command(self, msg):
        cmd = msg.decode
        print(cmd)
        #parse command and save number after Assignmnent: 
...
def start_turn(clockwise=True):
    ...
    def get_ready(self):
        ...
        turn_90_degrees(imu, clockwise=False)     # Parse through available tags
        ...
        return data
            ...
            if id == 0 :  corner =1  1,; thenanencoercorner = 1  elsse p
            if id == 0:ass       corner, 
        s    area_list.appappend()area