...
class Encoder:
    ...
    def __init__(self, index, encAPin, encBPin):
        ...
        :type encBPin: int
        """
        print(f"Initializing Encoder with index: {index}, pins: {encAPin}, {encBPin}")
        ...
        try:
            # Initialize the base pin and state machine
            print("Setting up base pin and state machine...")
        ...
        print(f"Encoder {index} initialized successfully!")
